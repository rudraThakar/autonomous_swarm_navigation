...
#ifndef COMMUNICATION_MSGS__SRV__DETAIL__LIVELINESS__FUNCTIONS_H_
#define COMMUNICATION_MSGS__SRV__DETAIL__LIVELINESS__FUNCTIONS_H_
...
/// Initialize srv/Liveliness message.
/**
...
/// Finalize srv/Liveliness message.
/**
...
/// Create srv/Liveliness message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * communication_msgs__srv__Liveliness_Request__init().
...
/// Destroy srv/Liveliness message.
/**
 * It calls
 * communication_msgs__srv__Liveliness_Request__fini()
...
/// Check for srv/Liveliness message equality.
/**
...
/// Initialize array of srv/Liveliness messages.
/**
...
/// Finalize array of srv/Liveliness messages.
/**
 * It calls
 * communication_msgs__srv__Liveliness_Request__fini()
...
/// Create array of srv/Liveliness messages.
/**
 * It allocates the memory for the array and calls
 * communication_msgs__srv__Liveliness_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Liveliness messages.
/**
 * It calls
 * communication_msgs__srv__Liveliness_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Liveliness message array equality.
/**
...
/// Copy an array of srv/Liveliness messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * communication_msgs__srv__Liveliness_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_msgs
...
/**
 * It calls
 * communication_msgs__srv__Liveliness_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_msgs
...
/**
 * It allocates the memory for the array and calls
 * communication_msgs__srv__Liveliness_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_communication_msgs
...
/**
 * It calls
 * communication_msgs__srv__Liveliness_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMMUNICATION_MSGS__SRV__DETAIL__LIVELINESS__FUNCTIONS_H_
