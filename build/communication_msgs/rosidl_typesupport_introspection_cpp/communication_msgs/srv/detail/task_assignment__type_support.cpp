...
{
  new (message_memory) communication_msgs::srv::TaskAssignment_Request(_init);
}

void TaskAssignment_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication_msgs::srv::TaskAssignment_Request *>(message_memory);
  typed_message->~TaskAssignment_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskAssignment_Request_message_member_array[2] = {
  {
    "task_id",  // name
    ...
    offsetof(communication_msgs::srv::TaskAssignment_Request, task_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication_msgs::srv::TaskAssignment_Request, coordinates),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskAssignment_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(communication_msgs::srv::TaskAssignment_Request),
...
{
  return &::communication_msgs::srv::rosidl_typesupport_introspection_cpp::TaskAssignment_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication_msgs, srv, TaskAssignment_Request)() {
  return &::communication_msgs::srv::rosidl_typesupport_introspection_cpp::TaskAssignment_Request_message_type_support_handle;
}
...
void TaskAssignment_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) communication_msgs::srv::TaskAssignment_Response(_init);
}

void TaskAssignment_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication_msgs::srv::TaskAssignment_Response *>(message_memory);
  typed_message->~TaskAssignment_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember TaskAssignment_Response_message_member_array[1] = {
  {
    "message",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication_msgs::srv::TaskAssignment_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TaskAssignment_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(communication_msgs::srv::TaskAssignment_Response),
...
{
  return &::communication_msgs::srv::rosidl_typesupport_introspection_cpp::TaskAssignment_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication_msgs, srv, TaskAssignment_Response)() {
  return &::communication_msgs::srv::rosidl_typesupport_introspection_cpp::TaskAssignment_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers TaskAssignment_service_members = {
  ...
  // see get_service_type_support_handle<communication_msgs::srv::TaskAssignment>()
...
get_service_type_support_handle<communication_msgs::srv::TaskAssignment>()
{
  ...
  auto service_type_support =
    &::communication_msgs::srv::rosidl_typesupport_introspection_cpp::TaskAssignment_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication_msgs, srv, TaskAssignment)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<communication_msgs::srv::TaskAssignment>();
}
