...
def generate_launch_description():
    ...
    urdf_path = 'src/autobot_recog/urdf/camera/model.sdf'
    ...
    for i in range(3):  # Hardcoded to 3 for now
        robot_name = f'robot_{i}'
        robot_namespace = f'/{robot_name}'
        
        #Remove the below comments if you want random initialization of bots.
