...
def generate_launch_description():
    ...
    # Paths
    world_path = 'src/autobot_recog/worlds/office_world.world'  # Relative to your project workspace
    urdf_path = os.path.join(pkg_share, 'models', 'turtlebot3_burger', 'model.sdf')  # Dynamically fetch URDF
