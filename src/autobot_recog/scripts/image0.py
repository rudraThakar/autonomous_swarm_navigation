...
class ImageSaver(Node):
    def __init__(self, save_interval=0.5):
        ...
        # Create a subscription to the image topic for robot_0
        self.bridge = CvBridge()
        self.image_sub = self.create_subscription(
            Image, 
            '/robot_0/camera/image_raw',  # Updated topic name
            self.image_callback, 
            10  # QoS depth
        )
        ...
        self.save_directory = "/home/rudra/bharatforge/abhiroop/src/autobot_recog/scripts/dataset"  # Updated save directory
        self.image_count = 0
